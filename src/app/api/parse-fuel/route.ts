...
Devuelve ÚNICAMENTE este JSON sin explicaciones ni markdown:
{
  ...
  "stationName": "nombre y dirección completa del grifo: las líneas que van debajo de la razón social, incluyendo el nombre del local y la dirección completa, todo junto separado por comas (ej: San Carlos, CAR. PANAMERICANA NORTE KM. 28.3, Puente Piedra-Lima)",
