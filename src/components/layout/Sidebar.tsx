...
import {
  ...
  MapPin, FileText, Fuel, Wrench, Circle, DollarSign, ChevronLeft, ChevronRight, UserRound, Receipt, AlertOctagon, History,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/sanciones",   label: "Sanciones",     icon: AlertOctagon,    roles: ["ADMINISTRADOR", "JEFE_TRANSPORTE", "SUPERVISOR", "ANALISTA"] },
  { href: "/bitacora",    label: "Bitácora",      icon: History,         roles: ["ADMINISTRADOR", "JEFE_TRANSPORTE", "SUPERVISOR", "ANALISTA"] },
